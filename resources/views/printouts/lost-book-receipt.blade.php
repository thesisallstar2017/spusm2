    ...
    <div class="printable">
        <div class="row">
            <div class="col-md-10 col-md-offset-1">
                <div>
                    <h2 class="text-center">LOST BOOK RECEIPT</h2>
                    <h3 class="text-center" style="color:#5cb85c; margin-top: 2px"> SAINT PAUL UNIVERSITY SAN MIGUEL BULACAN</h3>
