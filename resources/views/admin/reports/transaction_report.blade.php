...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12">
                <a href="/admin/reports/list/transaction-report" class="btn btn-primary btn-success pull-right">Download Transaction Reports</a>
            </div>
            ...
            <div class="col-sm-12 self-class">
                ...
                <div class="col-sm-3 search-panel">
                    ...
                    <br>
                    {!! BootForm::open()->action('/admin/reports/transaction/filter')->id('filters') !!}
...
@section('page_js')
    <script type="text/javascript">
        ...
        $("#download-pdf").click(function() {
            ...
            $.get("/admin/reports/download/transaction-report", form_data, function(data) {
