    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-6 col-sm-offset-3 self-class">
                <p style="font-size: 25px; text-align: center">Edit <strong style="color:#3c763d">MATERIAL {{ strtoupper($material->name) }}</strong></p>
                <br>
                {!! BootForm::open()->patch()->action(url('admin/materials/' . $material->id)) !!}
                {!! BootForm::bind($material) !!}
